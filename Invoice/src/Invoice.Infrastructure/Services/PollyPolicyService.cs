...
/// </summary>
public static class PollyPolicyService
{
    /// <summary>
    ...
    public static AsyncCircuitBreakerPolicy<HttpResponseMessage> CreateCircuitBreakerPolicy()
    {
        return HttpPolicyExtensions
            ...
            .CircuitBreakerAsync(
                ...
                {
                    // Circuit breaker açıldığında log
                    // Bu durumda logger'a erişim için context kullanılabilir
                },
                onReset: () =>
                {
                    // Circuit breaker kapandığında log
                },
                onHalfOpen: () =>
                {
                    // Circuit breaker yarı açık durumda
                });
    }
    ...
    public static AsyncRetryPolicy<HttpResponseMessage> CreateRateLimitRetryPolicy()
    {
        return Policy
