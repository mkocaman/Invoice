...
/// TRY format notu: Tüm para birimi işlemleri TRY (Türk Lirası) olarak yapılır.
/// </summary>
public static class MaskingHelper
{
    /// <summary>
    /// Genel amaçlı gizli anahtar maskeleme (API key, secret vs.)
    /// </summary>
    /// <param name="input">Masklenecek gizli veri</param>
    /// <returns>Maskelenmiş gizli veri</returns>
